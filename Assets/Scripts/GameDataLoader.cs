	...
	IEnumerator SearchWeatherData() {
		...
		while (island==false) {
						...
						if (request.error == null || request.error == "") {
								...
								if(island==false) {
										GlobalStuff.instance.lat = GlobalStuff.instance.lat + RandomExt.RandomFloatBetween(0,2);
										GlobalStuff.instance.lng = GlobalStuff.instance.lng + RandomExt.RandomFloatBetween(0,2);
					if(GlobalStuff.instance.lat>90) GlobalStuff.instance.lat=GlobalStuff.instance.lat-90;
					if(GlobalStuff.instance.lng>180) GlobalStuff.instance.lng= GlobalStuff.instance.lng-180;
									}
